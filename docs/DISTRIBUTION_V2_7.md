...
The package remains `com.credisafe.mobile` and version code advances to 26 for `2.7.0-beta.2`. Reuse the original beta signing certificate to support install-over updates.
